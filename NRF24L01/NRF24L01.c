...
void NRF24_Init(void)
{
    ...
    NRF24_set_Retries(15, 15); // Set retries (15) and delay (1250us)

    // 4. Data Rate
    NRF24_set_DataRate(RF24_250KBPS); // Choose desired data rate

    // 5. Power Level
    NRF24_set_PALevel(RF24_PA_m18dB); // Choose desired power level
    ...
    // 10. Set Channel
    NRF24_set_Channel(76); // Set communication channel
